<?php
/*Ce fichier fait partie detheme1, travel-agency child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function theme1_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'theme1_enqueue_child_styles' );
